...
<body>
    ...
    <footer class="footer">
        <div class="l-footer">
            <h1>
                <img src="Images/my.jpeg" class="img-fluid rounded " style="max-width:20%;" alt="">
            </h1>
            <p><b style="color: rgb(42, 194, 143);">RideConnect</b> is a family company, one that spans the globe and has shared ideals. We value service to each other and the world as much as to our customers.</p>
        </div>
        ...
        <div class="b-footer">
            ...
            ?>
                    <form>
                        ...
                        <p>All rights reserved by <span><b style="color: rgb(42, 194, 143);"> &copy; RideConnect</b></span> <?php echo $Year['year'] ?></p>
